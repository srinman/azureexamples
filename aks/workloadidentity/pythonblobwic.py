...
#workload_credential = WorkloadIdentityCredential(additionally_allowed_tenants=["d12058fe-ecf4-454a-9a69-cef5686fc24f"])

# Create the BlobServiceClient object
blob_service_client = BlobServiceClient(account_url, credential=workload_credential)
